  ...
  return (
    ...
    >
      <div className="container">
        ...
        {/* 3 Clean Image Cards with Just a CTA (No Writings on Image) */}
        <div
          style={{
            display: 'grid',
          ...
          {CARDS.map((card, idx) => (
            <div
              ...
              style={{
                ...
                padding: '36px 24px',
                cursor: 'pointer',
                boxShadow: '0 10px 30px rgba(28, 27, 26, 0.06)',
                transition: 'transform 0.35s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.35s ease',
                backgroundColor: '#f0ece5',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'translateY(-6px)';
                e.currentTarget.style.boxShadow = '0 20px 48px rgba(28, 27, 26, 0.12)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 10px 30px rgba(28, 27, 26, 0.06)';
              }}
            >
              ...
              {/* Pure CTA Button (All lead to dedicated concepts page) */}
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            <div>
              <div style={{ fontSize: '13px', fontWeight: 700, color: 'var(--color-text-main)', marginBottom: '2px' }}>
